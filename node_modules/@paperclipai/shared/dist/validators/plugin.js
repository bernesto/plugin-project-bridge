 ...
 */
export const jsonSchemaSchema = z.record(z.string(), z.unknown()).refine((val) => {
...
export const pluginUiSlotDeclarationSchema = z.object({
    ...
    if (value.type === "companySettingsPage"
        && value.routePath
        && PLUGIN_RESERVED_COMPANY_SETTINGS_ROUTE_SEGMENTS.includes(value.routePath)) {
        ctx.addIssue({
            code: z.ZodIssueCode.custom,
