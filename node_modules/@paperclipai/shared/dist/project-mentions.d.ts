...
export declare const ROUTINE_MENTION_SCHEME = "routine://";
...
export declare function buildRoutineMentionHref(routineId: string): string;
export declare function parseRoutineMentionHref(href: string): ParsedRoutineMention | null;
...
export declare function extractRoutineMentionIds(markdown: string): string[];
