 ...
 */
export declare const PLUGIN_UI_SLOT_TYPES: readonly ["page", "detailTab", "taskDetailView", "dashboardWidget", "sidebar", "routeSidebar", "sidebarPanel", "projectSidebarItem", "globalToolbarButton", "toolbarButton", "contextMenuItem", "commentAnnotation", "commentContextMenuItem", "settingsPage", "companySettingsPage"];
 ...
 */
export declare const PLUGIN_RESERVED_COMPANY_SETTINGS_ROUTE_SEGMENTS: readonly ["general", "environments", "access", "members", "invites", "secrets"];
export type PluginReservedCompanySettingsRouteSegment = (typeof PLUGIN_RESERVED_COMPANY_SETTINGS_ROUTE_SEGMENTS)[number];
/**
 ...
 */
export declare const PLUGIN_UI_SLOT_ENTITY_TYPES: readonly ["project", "issue", "agent", "goal", "run", "comment", "execution_workspace", "project_workspace"];
 ...
 */
export declare const PLUGIN_BRIDGE_ERROR_CODES: readonly ["WORKER_UNAVAILABLE", "CAPABILITY_DENIED", "INVOCATION_SCOPE_DENIED", "WORKER_ERROR", "TIMEOUT", "UNKNOWN"];
