import { EXPORT_NAMES, JOB_KEYS, PLUGIN_ID, PLUGIN_VERSION, SLOT_IDS, WEBHOOK_KEYS, } from "./constants.js";
const manifest = {
    id: PLUGIN_ID,
    apiVersion: 1,
    version: PLUGIN_VERSION,
    displayName: "Project Bridge",
    description: "Bridges external project management systems with Paperclip. Bidirectional sync of projects, tasks, issues, statuses, and assignments. Starts with Zoho Projects, extensible to other services.",
    author: "Neoreef",
